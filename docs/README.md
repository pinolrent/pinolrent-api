...
- **[Despliegue](despliegue.md)** — VPS con Coolify: contenedor, variables, backups y restauración.
...
> El [README raíz](../README.md) es la entrada rápida: qué hace el proyecto y cómo levantarlo.
